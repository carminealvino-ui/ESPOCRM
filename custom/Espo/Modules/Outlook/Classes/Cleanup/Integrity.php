...
namespace Espo\Modules\Outlook\Classes\Cleanup;
...
class Integrity implements Cleanup
{
    ...
    private string $hash = '320c7a67acf66e3d7f6c39334256c10f';
    ...
    public function __construct(
        ...
        $this->name = base64_decode('T3V0bG9vayBJbnRlZ3JhdGlvbg==');
        $this->file = base64_decode('Y3VzdG9tL0VzcG8vTW9kdWxlcy9PdXRsb29rL0NsYXNzZXMvQXBwL0pvYlJ1bm5lci5waHA=');
        $this->class = base64_decode('RXNwb1xNb2R1bGVzXE91dGxvb2tcQ2xhc3Nlc1xBcHBcSm9iUnVubmVy');
