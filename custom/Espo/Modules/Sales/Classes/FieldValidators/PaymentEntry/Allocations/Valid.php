...
namespace Espo\Modules\Sales\Classes\FieldValidators\PaymentEntry\Allocations;
...
class Valid implements Validator
{
    public function validate(Entity $entity, string $field, Data $data): ?Failure
    {
        ...
        if ($entity->getPartyType() === PartyType::Supplier) {
            $targetTypes = $entity->getType() === Type::Outbound ?
