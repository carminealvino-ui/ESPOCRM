...
namespace Espo\Modules\Sales\Classes\Record\WriteOffEntry;
...
/**
 * @implements Restorer<WriteOffEntry>
 */
class DeletedRestorer implements Restorer
{
    ...
    private function restoreAllocations(WriteOffEntry $entity, DateTime $modifiedAt): void
    {
        $update = UpdateBuilder::create()
            ->in(PaymentAllocation::ENTITY_TYPE)
            ->where([
                PaymentAllocation::ATTR_WRITE_OFF_ENTRY_ID => $entity->getId(),
