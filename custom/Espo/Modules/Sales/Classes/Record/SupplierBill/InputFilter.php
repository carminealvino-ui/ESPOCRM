...
namespace Espo\Modules\Sales\Classes\Record\SupplierBill;
...
class InputFilter implements Filter
{
    ...
    {
        if ($this->configDataProvider->isSupplierBillPostingDateEnabled()) {
            return;
        }

        $data->clear(OrderEntity::FIELD_POSTING_DATE);
    }
}
