...
namespace Espo\Modules\Sales\Classes\Record\SupplierCredit;
...
/**
 * @implements Restorer<SupplierCredit>
 */
class DeletedRestorer implements Restorer
{
    ...
    public function restore(Entity $entity): void
    {
        ...
        $this->restoreAllocations($entity, $modifiedAt);
    }

    private function restoreAllocations(SupplierCredit $entity, DateTime $modifiedAt): void
    {
        $update = UpdateBuilder::create()
            ->in(PaymentAllocation::ENTITY_TYPE)
            ->where([
                PaymentAllocation::ATTR_SUPPLIER_CREDIT_ID => $entity->getId(),
