...
namespace Espo\Modules\Sales\Classes\Record\PaymentEntry;
...
/**
 * @implements Restorer<PaymentEntry>
 */
class DeletedRestorer implements Restorer
{
    ...
    private function restoreAllocations(PaymentEntry $entity, DateTime $modifiedAt): void
    {
        $update = UpdateBuilder::create()
            ->in(PaymentAllocation::ENTITY_TYPE)
            ->where([
                PaymentAllocation::ATTR_PAYMENT_ENTRY_ID => $entity->getId(),
