...
namespace Espo\Modules\Sales\Classes\Record\Tax;
...
class DefaultsPopulator implements Populator
{
    ...
    public function populate(Entity $entity): void
    {
        if (
            ...
            !$entity->isAttributeWritten(Tax::FIELD_BASIS)
        ) {
            $entity->set(Tax::FIELD_BASIS, TaxBasis::Rate->value);
        }
    }
}
