...
namespace Espo\Modules\Sales\Classes\Record\CreditNote;
...
/**
 * @implements Restorer<CreditNote>
 */
class DeletedRestorer implements Restorer
{
    ...
    private function restoreAllocations(CreditNote $entity, DateTime $modifiedAt): void
    {
        $update = UpdateBuilder::create()
            ->in(PaymentAllocation::ENTITY_TYPE)
            ->where([
                PaymentAllocation::ATTR_CREDIT_NOTE_ID => $entity->getId(),
