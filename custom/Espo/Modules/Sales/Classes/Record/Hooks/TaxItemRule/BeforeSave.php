...
namespace Espo\Modules\Sales\Classes\Record\Hooks\TaxItemRule;
...
/**
 * @implements SaveHook<TaxItemRule>
 */
class BeforeSave implements SaveHook
{
     ...
     * @throws Forbidden
     */
    private function validateTaxCode(TaxItemRule $entity): void
    {
        if (!$entity->isAttributeChanged(TaxItemRule::ATTR_TAX_CODE_ID)) {
            return;
        }
