...
class ItemListLoader implements Loader
{
    ...
    public function process(Entity $entity, Params $params): void
    {
        ...
        $entity->set(OrderEntity::ATTR_ITEM_LIST, $itemDataList);

        if (!$entity->hasFetched(OrderEntity::ATTR_ITEM_LIST)) {
            $entity->setFetched(OrderEntity::ATTR_ITEM_LIST, $itemDataList);
        }
    }
}
