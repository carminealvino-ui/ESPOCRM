...
namespace Espo\Modules\Sales\Classes\Acl\SubscriptionPeriod;
...
/**
 * @implements OwnershipOwnChecker<SubscriptionPeriod>
 * @implements OwnershipTeamChecker<SubscriptionPeriod>
 */
class OwnershipChecker implements OwnershipOwnChecker, OwnershipTeamChecker
{
    ...
    private function getSubscription(SubscriptionPeriod $entity): ?Subscription
    {
        try {
