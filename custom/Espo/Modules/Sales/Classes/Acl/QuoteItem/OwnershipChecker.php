...
/**
 * @implements OwnershipOwnChecker<QuoteItem>
 * @implements OwnershipTeamChecker<QuoteItem>
 */
class OwnershipChecker implements OwnershipOwnChecker, OwnershipTeamChecker
{
    ...
    {
        return OrderEntityUtil::getItemParentField($entity->getEntityType());
    }

    private function getParent(QuoteItem $entity): ?Entity
    {
        $parentField = $this->getParentField($entity);
