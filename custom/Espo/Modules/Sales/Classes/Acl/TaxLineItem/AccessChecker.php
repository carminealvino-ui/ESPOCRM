...
namespace Espo\Modules\Sales\Classes\Acl\TaxLineItem;
...
/**
 * Used also by TaxTotalItem.
 *
 * @implements AccessEntityCREDChecker<TaxLineItem|TaxTotalItem>
 */
class AccessChecker implements AccessEntityCREDChecker
{
    ...
    {
        $order = $entity->getSource();

        return $this->aclManager->checkEntityRead($user, $order);
    }
