...
use Espo\Modules\Sales\Classes\FieldLoaders\InventoryNumber\QuantityInTransit as QuantityInTransitLoader;
...
class QuantityInTransit implements Func
{
    ...
    public function process(EvaluatedArgumentList $arguments): float
    {
        ...
        $product = $this->entityManager->getRDBRepositoryByClass(InventoryNumber::class)->getById($id);
