...
class Integrity implements Cleanup
{
    ...
    private string $hash = 'df439b7b3e5818b10c00730f6890653a';
    ...
    public function __construct(
        ...
        $this->name = base64_decode('U2FsZXMgUGFjaw==');
        $this->file = base64_decode('Y3VzdG9tL0VzcG8vTW9kdWxlcy9TYWxlcy9DbGFzc2VzL0FwcC9Kb2JSdW5uZXIucGhw');
        $this->class = base64_decode('RXNwb1xNb2R1bGVzXFNhbGVzXENsYXNzZXNcQXBwXEpvYlJ1bm5lcg==');
