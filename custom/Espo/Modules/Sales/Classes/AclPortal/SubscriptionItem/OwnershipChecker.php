...
/**
 * @implements OwnershipAccountChecker<SubscriptionItem>
 * @implements OwnershipContactChecker<SubscriptionItem>
 * @implements OwnershipOwnChecker<SubscriptionItem>
 */
class OwnershipChecker implements OwnershipAccountChecker, OwnershipContactChecker, OwnershipOwnChecker
{
    ...
    public function checkAccount(User $user, Entity $entity): bool
    {
        if ($entity->getSubscription()) {
            return $this->aclManager->checkOwnershipAccount($user, $entity->getSubscription());
        }

        if ($entity->getSubscriptionUpdate()) {
            return $this->aclManager->checkOwnershipAccount($user, $entity->getSubscriptionUpdate());
        }
    ...
    {
        if ($entity->getSubscription()) {
            return $this->aclManager->checkOwnershipContact($user, $entity->getSubscription());
        }

        if ($entity->getSubscriptionUpdate()) {
            return $this->aclManager->checkOwnershipContact($user, $entity->getSubscriptionUpdate());
        }
    ...
    {
        if ($entity->getSubscription()) {
            return $this->aclManager->checkOwnershipOwn($user, $entity->getSubscription());
        }

        if ($entity->getSubscriptionUpdate()) {
            return $this->aclManager->checkOwnershipOwn($user, $entity->getSubscriptionUpdate());
        }
