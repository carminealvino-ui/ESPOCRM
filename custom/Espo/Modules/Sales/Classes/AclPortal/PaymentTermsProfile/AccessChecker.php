...
namespace Espo\Modules\Sales\Classes\AclPortal\PaymentTermsProfile;
...
/**
 * @implements AccessEntityCREDChecker<PaymentTermsProfile>
 */
class AccessChecker implements AccessEntityCREDChecker
{
    ...
    {
        foreach (OrderEntityUtil::getEntityTypesWithPaymentTermsProfile() as $itEntityType) {
            if (
