...
namespace Espo\Modules\Sales\Hooks\PaymentTermsProfile;
...
/**
 * @implements AfterRemove<PaymentTermsProfile>
 */
class DeleteItems implements AfterRemove
{
    ...
    public function afterRemove(Entity $entity, RemoveOptions $options): void
    {
        $items = $this->entityManager
            ->getRDBRepositoryByClass(PaymentTermsProfileItem::class)
            ->where([
