...
class SetValues implements BeforeSave
{
    ...
    private function setStateFields(SupplierBill $entity): void
    {
    ...
    private function setSupplierFields(SupplierBill $entity): void
    {
        if (!$entity->isNew() && !$entity->isAttributeChanged(SupplierBill::FIELD_SUPPLIER . 'Id')) {
            return;
        }
