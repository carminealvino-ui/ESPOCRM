...
namespace Espo\Modules\Sales\Hooks\TaxPurchaseRule;
...
/**
 * @implements BeforeSave<TaxPurchaseRule>
 * @implements AfterRemove<TaxPurchaseRule>
 */
class Order implements BeforeSave, AfterRemove
{
    ...
    public function beforeSave(Entity $entity, SaveOptions $options): void
    {
        ...
        $query = SelectBuilder::create()
            ->from(TaxPurchaseRule::ENTITY_TYPE)
