 ...
 */
class CreditNote extends OrderEntity
    implements TaxableOrder, RoundingHavingOrder, IssuableOrder, HavingTaxInclusiveOrder, HavingCurrencyRateEntity
{
    ...
    {
        /** @var ?Invoice */
        return $this->relations->getOne('invoice');
    }
    ...
    {
        /** @var ?Currency */
        return $this->getValueObject('shippingCost');
    }
    ...
    {
        return $this->setRelatedLinkOrEntity('invoice', $invoice);
    }
