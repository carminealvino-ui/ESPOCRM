...
class OrderItemsService
{
    ...
    private array $entityTypes = [
        ...
        ReceiptOrderReceivedItem::ENTITY_TYPE, // @todo
     ...
     * @throws Forbidden
     */
    public function find(InventoryNumber $inventoryNumber, SearchParams $searchParams): Collection
    {
        ...
        foreach ($entityTypes as $entityType) {
            $parentEntityType = OrderEntityUtil::getItemParentEntityType($entityType);
            $parentLink = OrderEntityUtil::getItemParentField($entityType);
            ...
            $itemBuilder->where(['inventoryNumberId' => $inventoryNumber->getId()]);
