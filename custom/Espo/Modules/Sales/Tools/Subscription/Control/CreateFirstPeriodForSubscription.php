...
use Espo\Modules\Sales\Tools\Subscription\CreateUpcomingPeriod;
use Espo\Modules\Sales\Tools\Subscription\PointerData;
use Espo\Modules\Sales\Tools\Subscription\Util;

class CreateFirstPeriodForSubscription
{
    ...
    public function process(Subscription $subscription): void
    {
        ...
        $this->createUpcomingPeriod->process($pointerData);
    }
}
