...
namespace Espo\Modules\Sales\Tools\EuTaxMapping\Api;
...
class PostMove implements Action
{
     ...
     * @throws NotFound
     */
    private function getProfile(Request $request): EuTaxMapping
    {
        $id = $request->getRouteParam('id') ?? throw new BadRequest();

        $rule = $this->entityProvider->getByClass(EuTaxMapping::class, $id);
