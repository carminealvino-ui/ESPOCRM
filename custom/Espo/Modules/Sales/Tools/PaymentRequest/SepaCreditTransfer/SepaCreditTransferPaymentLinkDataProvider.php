...
namespace Espo\Modules\Sales\Tools\PaymentRequest\SepaCreditTransfer;
 ...
 */
class SepaCreditTransferPaymentLinkDataProvider implements PaymentLinkDataProvider
{
    ...
    public function get(PaymentRequest $request): stdClass
    {
        ...
        if (!$record instanceof PaymentChannelSepaCreditTransfer) {
            throw new RuntimeException("Not a SEPA Credit Transfer record.");
        }
    ...
    {
        $fields = $this->defaultLanguage->get(PaymentChannelSepaCreditTransfer::ENTITY_TYPE . '.fields') ?? (object) [];
    ...
    private function getValues(PaymentChannelSepaCreditTransfer $record): stdClass
    {
        return (object) [
