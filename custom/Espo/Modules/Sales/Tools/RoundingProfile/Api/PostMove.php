...
namespace Espo\Modules\Sales\Tools\RoundingProfile\Api;
...
class PostMove implements Action
{
    ...
    public function process(Request $request): Response
    {
        ...
        $this->service->move($profile, $type, $searchParams);
     ...
     * @throws NotFound
     */
    private function getProfile(Request $request): RoundingProfile
    {
        $id = $request->getRouteParam('id') ?? throw new BadRequest();

        $rule = $this->entityProvider->getByClass(RoundingProfile::class, $id);
