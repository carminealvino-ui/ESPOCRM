...
use Espo\Modules\Sales\Entities\SupplierBill as SupplierBillEntity;
...
/**
 * @extends Database<SupplierBillEntity>
 */
class SupplierBill extends Database implements Di\InjectableFactoryAware
{
    use Di\InjectableFactorySetter;

    /**
     * @param SupplierBillEntity $entity
     */
    public function save(Entity $entity, array $options = []): void
    {
        ...
        if (
            ...
            $entity->setStatus(SupplierBillEntity::STATUS_DRAFT);
        }
