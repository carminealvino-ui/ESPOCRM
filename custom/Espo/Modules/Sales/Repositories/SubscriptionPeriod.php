...
/**
 * @extends Database<Period>
 * @noinspection PhpUnused
 */
class SubscriptionPeriod extends Database
{
    /**
     * @param Period $entity
     */
    ...
    private function lock(Period $entity): void
    {
        if (
            $entity->isNew() ||
            !$entity->isAttributeChanged(Period::FIELD_START_DATE) &&
            !$entity->isAttributeChanged(Period::FIELD_END_DATE) &&
            !$entity->isAttributeChanged(Period::FIELD_STATUS) &&
            !$entity->isAttributeChanged(Period::FIELD_BILLING_STATUS)
        ) {
            return;
        }
