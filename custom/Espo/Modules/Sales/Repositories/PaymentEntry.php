...
use Espo\Modules\Sales\Entities\PaymentEntry as PaymentEntryEntity;
...
/**
 * @extends Database<PaymentEntryEntity>
 */
class PaymentEntry extends Database implements Di\InjectableFactoryAware
{
    use Di\InjectableFactorySetter;

    /**
     * @param PaymentEntryEntity $entity
     */
    public function save(Entity $entity, array $options = []): void
    {
        ...
        if (
            ...
            $entity->setStatus(PaymentEntryEntity::STATUS_DRAFT);
        }
        ...
        if (
            ...
            empty($options[CoreSaveOption::IMPORT]) &&
            !$entity->isAttributeChanged(PaymentEntryEntity::FIELD_STATUS) &&
