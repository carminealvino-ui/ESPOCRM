...
use Espo\Modules\Sales\Entities\SupplierCredit as SupplierCreditEntity;
...
/**
 * @extends Database<SupplierCreditEntity>
 */
class SupplierCredit extends Database implements Di\InjectableFactoryAware
{
    use Di\InjectableFactorySetter;

    /**
     * @param SupplierCreditEntity $entity
     */
    public function save(Entity $entity, array $options = []): void
    {
        ...
        if (
            ...
            $entity->setStatus(SupplierCreditEntity::STATUS_DRAFT);
        }
