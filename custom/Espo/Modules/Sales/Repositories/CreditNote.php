...
/**
 * @extends Database<CreditNoteEntity>
 */
class CreditNote extends Database implements Di\InjectableFactoryAware
{
    use Di\InjectableFactorySetter;

    /**
     * @param CreditNoteEntity $entity
     */
    public function save(Entity $entity, array $options = []): void
    {
        ...
        if (
            ...
            $entity->setStatus(CreditNoteEntity::STATUS_DRAFT);
        }
