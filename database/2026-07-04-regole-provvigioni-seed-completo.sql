-- ========================================
-- Seed completo regole provvigionali
-- ARQUATI PNC (22 regole) + Ariel 2026 (3 regole)
-- Eseguire DOPO creazione tabella regola_provvigionale
-- Alternativa CLI: php tools/seed-regole-provvigioni.php
-- ========================================
...
-- GDL / Ariel Energia — provvigioni da 01/02/2026
INSERT INTO regola_provvigionale (
    id, name, description, deleted, attiva, priorita,
    regime_provvigione, tipo_calcolo, tipo_provvigione_record,
