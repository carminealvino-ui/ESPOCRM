...
<div class="cell record no-side-margin esito-popup-record">
    <div class="field-holder {{dateHolderClass}}"></div>
    {{#each fieldHolderClasses}}
    <div class="field-holder {{this}}"></div>
    {{/each}}
</div>
