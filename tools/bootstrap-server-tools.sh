...
TOOL_FILES=(
  ...
  "tools/bootstrap-guardrail-appuntamento.sh"
...
echo "  php tools/verify-appuntamento-baseline.php"
echo "  bash tools/pre-deploy-check-appuntamento.sh"
...
echo ""
echo "Se verify/pre-deploy mancano su main: bash tools/bootstrap-guardrail-appuntamento.sh"
