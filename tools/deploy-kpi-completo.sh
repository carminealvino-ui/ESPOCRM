...
echo ""
echo "Solo UI vecchia ma dati OK? Usa deploy-kpi-ui-only.sh (non riscrive PHP)."
...
echo "NON sovrascrive Global.json. Dopo il deploy: php clear_cache.php && php rebuild.php"
