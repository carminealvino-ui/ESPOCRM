...
download_one "custom/Espo/Custom/Resources/metadata/clientDefs/Task.json"
download_one "custom/Espo/Custom/Resources/metadata/entityDefs/Task.json"
download_one "client/custom/src/handlers/task/auto-date-completed-on-save.js"
download_one "client/custom/src/views/appuntamento/popup-notification.js"
