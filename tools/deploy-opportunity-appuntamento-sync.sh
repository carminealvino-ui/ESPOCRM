...
FILES=(
  ...
  "custom/Espo/Custom/Services/OpportunityPriceBookResolver.php"
...
echo "=== Deploy sync Appuntamento → Opportunità v1.0.7 ==="
...
echo "Sync attivo su Crea Opportunità (appuntamento-sync.js v1.0.7)."
