...
echo "  - Provvigioni: ricalcolo su cambio prezzo codice; totale aggiornato dopo salvataggio"
echo "  - Importo Caparra editabile in Panoramica (non duplicato nel pannello Finanziamento)"
echo ""
