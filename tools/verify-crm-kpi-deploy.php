...
$checks = [
    'client/custom/src/views/dashlets/crm-kpi.js' => 'kpi-tile-labels-v4',
    ...
    'custom/Espo/Custom/Controllers/Appuntamento.php' => 'injectableFactory->create(CrmKpiService::class)',
    ...
    'custom/Espo/Custom/Services/CrmKpi/CrmKpiService.php' => 'isQuoteRecesso',
    'custom/Espo/Custom/Tools/CrmKpi/FunnelBuilder.php' => 'buildSalesPipeline',
    'custom/Espo/Custom/Tools/CrmKpi/YieldBuilder.php' => 'applyColumnSharePercents',
