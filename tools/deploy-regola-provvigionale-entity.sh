...
echo ""
echo "Popolare regole (25 regole ARQUATI + Ariel):"
echo "  curl -fsSL \"https://raw.githubusercontent.com/${REPO}/${BRANCH}/tools/deploy-regole-provvigioni-seed.sh?t=\$(date +%s)\" | bash"
echo "  oppure: php tools/seed-regole-provvigioni.php"
